		...
		<div id="center_top_left_b">
			<ul>
				<c:forEach items="${infotypeList }" var="infotype">
					<li><a
						href="companyinfo.action?op=show&typename=${infotype.typename }">${infotype.typename }</a></li>
				</c:forEach>
	...
	<div id="toutiaoxinwen">
		<div id="center_top_right_c">
				...
				<div id="center_top_right_c_r">
							...
							<c:if
									test="${ requestScope.companyinfo.picture == null || requestScope.companyinfo.picture == ' '}">
