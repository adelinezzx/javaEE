...
public class Board implements Serializable {
	...
	public Integer getRecenttopicid() {
		return recenttopicid;
	}

	public void setRecenttopicid(Integer recenttopicid) {
	...
	public Integer getRecenttopicuserid() {
		return recenttopicuserid;
	}

	public void setRecenttopicuserid(Integer recenttopicuserid) {
		this.recenttopicuserid = recenttopicuserid;
	}

	public String getRecenttopicusername() {
		return (recenttopicusername == null ? " " : recenttopicusername);
	}
	...
	public String getRecenttopicmodifytime() {
		...
		return ( recenttopicmodifytime == null ? " " :  recenttopicmodifytime );
	}
	...
	private Integer recenttopicid;
	private String recenttopictitle;
	private Integer recenttopicuserid;
